...
{
    [HarmonyPatch]
    public static class ExtendedItemTooltipPatches
    {
        ...
        internal static IEnumerable<CodeInstruction> ReplaceReferences(this IEnumerable<CodeInstruction> instructions, FieldInfo target, MethodInfo replacement, bool localize = true)
        {
            ...
            if (patches == 0)
                CaudexLibPlugin.Log.LogError("ExtendedItemPatches.ReplaceReferences transpiler did not find anything to patch!");
        }
        ...
        internal static IEnumerable<CodeInstruction> ReplaceDirectLocalization(this IEnumerable<CodeInstruction> instructions, FieldInfo target, MethodInfo replacement)
        {
            ...
            if (patches == 0)
                CaudexLibPlugin.Log.LogError("ExtendedItemPatches.ReplaceDirectLocalization transpiler did not find anything to patch!");
        }
    ...
    internal static class ExtendedItemUsePatch
    {
        ...
        private static bool MultiItemExtraCheck(Item itm, PlayerManager pm)
        {
            ...
            return itmObj != pm.itm.items[pm.itm.selectedItem];
        }

        private static readonly MethodInfo multiItemCheck = AccessTools.Method(typeof(ExtendedItemUsePatch), "MultiItemExtraCheck");
        private static readonly MethodInfo itemUsedMethod = AccessTools.Method(typeof(ExtendedItemUsePatch), "ItemUseSuccess");
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            if (!patched)
                CaudexLibPlugin.Log.LogError("ExtendedItemUsePatch.Transpiler transpiler did not get properly applied!");
        }
    }
}